...
int main() {
    ...
    std::cout << "Sender: " << pk2.getSenderName() << std::endl;
    std::cout << pk2.getSenderAddr() << std::endl;
    ...
    std::cout << "Sender: " << pk3.getSenderName() << std::endl;
    std::cout << pk3.getSenderAddr() << std::endl;
